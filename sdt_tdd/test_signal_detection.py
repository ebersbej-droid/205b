...
class TestSignalDetection(unittest.TestCase):
    ...
    def test_hit_rate_denominator_zero(self):
        ...
        self.assertEqual( str(context.exception), "Hit rate is undefined! Error: hits + misses = 0")

    def test_false_alarm_rate_denominator_zero(self):       
        with self.assertRaises(ValueError) as context:
            self.zero_fa_den.false_alarm_rate()
        self.assertEqual( str(context.exception), "False alarm rate is undefined! Error: false_alarms + correct_rejections = 0")
    ...
    def test_subtraction(self):
        ...
        #result = sd1 - sd2 -> this was cool to see that this raised the error for having a negative hit
        result = sd2 - sd
